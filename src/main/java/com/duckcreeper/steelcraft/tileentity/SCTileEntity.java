...
public class SCTileEntity extends TileEntityLockable implements ISidedInventory
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.sctileentity";
	}
	...
	{
		return new ContainerSCTileEntity(playerInventory, this, 0, 0);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player) {
		player.openGui(SteelMain.instance, 0, world, x, y, z);
				return true;
		}
}